	...
	zixia_jianqi={ --×ÏÏ¼½£Æø
		...
		skill_skillexp_v={{	{1,17851239},
			...
			function(level)
				...
				return format("Sinh mÖnh thÊp h¬n 25%% trong chíp m¾t cã <color=orange>%d%%<color> tû lÖ mçi nöa gi©y håi phôc sinh lùc %d ®iÓm, kÐo dµi trong %d gi©y\n", nMag, nPois, nTime)
			end,
	},
	...
	shenguang_xuanrao1={ --Éñ¹âÐýÈÆ
		...
		skill_desc=
			function(level)
				...
				return format("Bïng næ <color=blue>Ma V©n KiÕm KhÝ<color> xung quanh trong ph¹m vi <color=orange>%d<color>\ng©y ra s¸t th­¬ng cao vµ ph¸ hiÖu qu¶ ®ãng b¨ng.\n", nMag)
			end,
		skill_skillexp_v={{	{1,300},
												{2,600},
												{3,1000},
