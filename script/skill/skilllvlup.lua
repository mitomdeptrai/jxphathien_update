...
function SOSkillLevelUp.Pililuanhuan_ji()
	local perSkills={{45,"PhÝch LÞch ®¬n"},{351,"Lo¹n Hoµn KÝch"}}
...
function SOSkillLevelUp.Shehun_luanxin()
	local perSkills={{136,"Háa Liªn PhÇn Hoa"},{137,"¶o ¶nh Phi Hå"},{140,"Phi Hång V« TÝch"},{364,"Bi T« Thanh Phong"},{143,"LÞch Ma §o¹t Hån"}}
